...
export const AlbumCard = ({ album }: { album: Album }) => {
  ...
  return (
    <div
      key={album._id}
      className="group cursor-pointer hover:shadow-md transition-shadow bg-white dark:bg-stone-900 rounded-lg shadow-sm p-3 min-w-[135px] max-w-[135px] lg:min-w-[150px] lg:max-w-[150px] text-clip "
    >
