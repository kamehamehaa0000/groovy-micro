...
export const PlaylistCard = ({
  ...
  return (
    <div
      key={playlist._id}
      className="group cursor-pointer hover:shadow-md transition-shadow bg-white rounded-lg shadow-sm p-3 min-w-[140px] max-w-[140px] lg:min-w-[150px] lg:max-w-[150px] text-clip "
    >
