  ...
  if (isExpanded) {
    return (
      <motion.div
        ...
        className="w-full sm:w-[350px] h-full bg-white p-6 flex flex-col z-50 overflow-y-auto scrollbar-hide shadow-lg rounded-lg border border-gray-200"
      >
        {/* Header */}
        ...
        <div className="flex flex-col items-center mb-6">
          ...
          <div className="text-center">
            ...
            <p className="text-sm text-gray-600 mb-2">{currentTrack.artist}</p>
          </div>
        </div>
        ...
        {/* Controls */}
        <div className="flex items-center justify-center space-x-4 mb-4 p-2  ">
        ...
        <div className="flex-1 space-y-2  ">
          <h3 className="text-sm font-semibold mb-4 text-gray-700 pb-2 border-b border-gray-100">
            Next Songs
          </h3>
          <div className="space-y-2 h-60 overflow-y-auto scrollbar-hide">
        ...
        {/* Volume */}
        <div className="hidden sm:block mb-6 p-3 bg-gray-50 rounded-lg border border-gray-100">
