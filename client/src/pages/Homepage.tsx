            ...
            albums?.map((album: any) => (
              ...
              >
                <div className="relative mb-2">
                  ...
                  />
                  <button className="absolute bottom-2 right-2 w-8 h-8 rounded-full bg-black/80 hover:bg-black opacity-0 group-hover:opacity-100 transition-opacity flex items-center justify-center">
