...
export const initialTrackInputSchema = z.object({
  ...
  primaryGenre: z.string().max(60).optional(),
  ...
  energy: z.coerce.number().min(0).max(1).nullable().optional(),
...
export const updateAlbumSchema = z.object({
  ...
  primaryGenre: z.string().max(60).nullable().optional(),
  subGenre: z.string().max(80).nullable().optional(),
  moods: z.array(z.string()).max(10).optional(),
  tags: z.array(z.string()).max(30).optional(),
  releaseDate: z
    .string()
